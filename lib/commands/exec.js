...
module.exports = {
  ...
  async i2cReadAsync (len) {
    try {
      ...
      // console.log('error in i2cReadAsync')
      throw e
    }
  },
  ...
  async i2cWriteAsync (data) {
    try {
      ...
      console.log('error in i2cWriteAsync')
      throw e
    }
  },
...
try {
    ...
    if (data.length === 1) {
      ...
      if (val === 0x00) {
        ...
        // we dont use _handleResponse in wakeAsync, 
  ...
  console.log('error in _handleResponse')
  throw e
}
  },
    ...
    while (count--) {
      try {
        ...
        if (e.code === 'ECC_FAULT' || e.code === 'ECC_WATCHDOG') {
          ...
          e.from = 'rethrown from execAsync'
          throw e
        }
      }
    }
...
try {
  ...
  console.log('error in wakeAsync')
  throw e
}
  },
...
try {
  ...
  console.log('error in idleAsync')
  throw e
}
  },
...
try {
  ...
  console.log('error in sleepAsync')
  throw e
}
  }
}
