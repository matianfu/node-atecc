...
*/
  ...
  */
  ...
  async atcabSignAsync (keyId, msg) {
    ...
    await this.atcabNonceLoadAsync(nonce_target, msg.slice(0, 32))
    return this.atcabSignBaseAsync(SIGN_MODE_EXTERNAL | sign_source, keyId)
  }
